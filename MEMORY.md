...
### Fixes Applied (14/06/2026)
- Changed backup dir from `/tmp/` → `~/.openclaw/state/` (permissions 600)
- Added auto-cleanup: keeps 7 latest backups on Drive, deletes older
- Made `find-new.mjs` & `compare-playlist.mjs` self-sufficient (fetch playlist with yt-dlp internally)
- Migrated 5 remaining scripts to shared `sheets-jwt.mjs` module
- Set up Git: remote origin → github.com/logen007/openclaw.git, pushed 41 files
- Pushed to public repo: https://github.com/logen007/openclaw
